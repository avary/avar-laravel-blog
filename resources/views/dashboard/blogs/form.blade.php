            ...
            <form id="BlogsForm">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <input type="text" class="form-control" id="blogsDate" placeholder="<?php echo date('Y-m-d'); ?>">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <input type="text" class="form-control" id="blogsAuthorImageUrl" placeholder="https://avatars.githubusercontent.com/u/399758?v=4" value="https://avatars.githubusercontent.com/u/399758?v=4">
                </div>
                <div class="col-12">
                  <hr>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <input type="text" class="form-control" id="blogsImageUrlLandscape" placeholder="https://picsum.photos/350/300" value="https://picsum.photos/350/300">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
